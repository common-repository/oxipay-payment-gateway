...
Price widget insertion now at bottom of single product summary
...
Insert price widget into footer for speed and compatibility improvements.

= 1.8.1 =
*Release Date 14 Oct 2019*
Option to specify price widget element selector. Allows more precise price-info widget insertion.

= 1.8.0 =
*Release Date 30 Sep 2019*
1. Change checkout platform from "WooCommerce" to "Default" to prepare for deprecating the translation layer.
2. Add a spinner effect in checkout page when waiting to be redirected to humm gateway, for customers to wait patiently to be redirected.

= 1.7.7 =
*Release Date 6 Sep 2019*
Added dynamic price-info widget option to allowing tracking of changing prices on product pages.
